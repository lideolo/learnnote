...
_C.TRAIN.SEED = 100
_C.TRAIN.LOSS = CN()
_C.TRAIN.LOSS.TIME_WEIGHT = 0.2
_C.TRAIN.LOSS.FREQ_CE_WEIGHT = 1.0
_C.TRAIN.LOSS.FREQ_KL_WEIGHT = 0.0
_C.TRAIN.LOSS.FREQ_STD = 3.0
_C.TRAIN.LOSS.ROI_PHASE_WEIGHT = 0.0
_C.TRAIN.LOSS.HARMONIC_WEIGHT = 0.0
_C.TRAIN.LOSS.AUX_HR_WEIGHT = 0.0
_C.TRAIN.LOSS.AUX_HR_STD = 3.0
# Optimizer
...
_C.TRAIN.MODEL_SELECTION = CN()
_C.TRAIN.MODEL_SELECTION.METRIC = 'loss'
# Train.Data settings
_C.TRAIN.DATA = CN()
...
# -----------------------------------------------------------------------------
# Model Settings for RhythmMamba
# -----------------------------------------------------------------------------
_C.MODEL.RHYTHMMAMBA = CN()
_C.MODEL.RHYTHMMAMBA.DEPTH = 24
_C.MODEL.RHYTHMMAMBA.EMBED_DIM = 96
_C.MODEL.RHYTHMMAMBA.MLP_RATIO = 2
_C.MODEL.RHYTHMMAMBA.DROP_PATH_RATE = 0.1
_C.MODEL.RHYTHMMAMBA.MAMBA_D_STATE = 48
_C.MODEL.RHYTHMMAMBA.MAMBA_D_CONV = 4
_C.MODEL.RHYTHMMAMBA.MAMBA_EXPAND = 2
_C.MODEL.RHYTHMMAMBA.MULTI_TEMPORAL_PATHS = 3
_C.MODEL.RHYTHMMAMBA.USE_ROI_STEM = False
_C.MODEL.RHYTHMMAMBA.ROI_COUNT = 5
_C.MODEL.RHYTHMMAMBA.ROI_RESIDUAL_SCALE = 1.0
_C.MODEL.RHYTHMMAMBA.USE_SPECTRAL_GATE = False
_C.MODEL.RHYTHMMAMBA.USE_PERIODIC_PE = False
_C.MODEL.RHYTHMMAMBA.USE_PERIODIC_MODULATION = False
_C.MODEL.RHYTHMMAMBA.RETURN_AUX = False
_C.MODEL.RHYTHMMAMBA.LOAD_STRICT = True
_C.MODEL.RHYTHMMAMBA.SPECTRAL_HR_LOW = 0.7
_C.MODEL.RHYTHMMAMBA.SPECTRAL_HR_HIGH = 2.5
_C.MODEL.RHYTHMMAMBA.SPECTRAL_PRIOR_STRENGTH = 0.2
_C.MODEL.RHYTHMMAMBA.SPECTRAL_ADAPTIVE_STRENGTH = 0.1
...
_C.INFERENCE.TTA = CN()
_C.INFERENCE.TTA.HORIZONTAL_FLIP = False
_C.INFERENCE.TTA.ALIGN_SIGN = True
