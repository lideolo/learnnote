...
class UBFCrPPGLoader(BaseLoader):
    ...
    def read_video(video_file):
        """Reads a video file, returns frames(T, H, W, 3) using ffmpeg CLI to avoid OpenCV VideoCapture libc conflicts."""
        ...
        # Decode video to raw RGB24 via ffmpeg pipe
        ffmpeg_cmd = [
        ...
        # Convert raw bytes to numpy array: (T, H, W, 3)
        total_pixels = len(raw_data) // 3
